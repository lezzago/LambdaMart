...
def create_leaf(label):
	...
	leaf_list.append(leaf['value'])
	return leaf


def create_tree(data, all_pos_split, label, current_depth = 0, max_depth = 50, ideal_ls = 100):
	...
	# #Additional stopping condition (limit tree depth)
		...
		print "reached max depth, stopping for now."
		return create_leaf(label)
...
if __name__ == '__main__':
	...
	test = [[478, 184, 40, 74, 11, 31], [494,  213,  32,  72,  11,  43,  18]]
	label = data['X7']
	del data['X7']
	...
	tree = create_tree(data, all_pos_split, label, current_depth = 0, max_depth = 50, ideal_ls = 0.05)
